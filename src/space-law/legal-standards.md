...
### What Reasonable Suspicion Permits

- Temporary detention for questioning
- Requests for identification
- Limited investigation (observation, follow-up questions)

### What Reasonable Suspicion Does Not Authorize

- Arrest or charging
- Conviction
- Issuing or executing search warrants
- Full personal, vessel, or department searches (except where otherwise authorized by law or alert level)

### How Reasonable Suspicion May Be Established

- Matching a known suspect description
- Presence at a crime scene under suspicious circumstances
...
### What Probable Cause Permits

- Arrest and detention
- Application for and execution of search warrants
- Personal searches incident to arrest
- Seizure of evidence
- Implant searches where otherwise authorized by law

### How Probable Cause May Be Established

- Direct observation of a crime being committed
- Physical evidence linking the individual to a crime
- Security records (camera footage, access logs, station records)
- Forensic evidence
...
- Witness testimony
- Physical evidence (weapons, stolen items, contraband)
- Forensic evidence (medical scans, chemical analysis)
- Security records and camera footage
- Confessions and admissions
- Investigative reports

### Key Principles

- The **absence of direct evidence** does not automatically prevent a charge if the totality of available evidence reasonably supports it.
- No individual shall be convicted on **unsupported hearsay alone** — corroboration is required.
...
## Applying Standards to the Elements of a Crime
...
*See [Crimes & Punishments](crimes-and-punishments.md) for individual offense elements and [Legal Procedures](legal-procedures.md) for arrest and search procedures.*
