...
| M13 | **Cooperation with Security** | To completely comply and work with security during detainment, search, or arrest — such as willingly being cuffed or actively turning oneself in. In cases of Capital crimes, lowers punishment to Permanent Confinement. | 25% punishment decrease |
...
|:----:|:------|:---------|:-----------------|:-----------|
| <a id="003"></a>003 | **Superficial Vandalism** | • Defaced station property or property belonging to another individual | ↓ Greater: [103 — Minor Vandalism](#103) | Force repairing or 15k speso fine |
| <a id="006"></a>006 | **Drug Possession** | • Possessed illegal drugs<br>• In quantities consistent with personal use | ↓ Greater: [106 — Illegal Distribution](#106) | Confiscation and 25k speso fine |
| 007 | **Disorderly Conduct** | • Conducted oneself in a manner unsuitable for their position | — | [Brig until 25k speso fine paid](#112); with [M02](#m02): demotion |
| 008 | **Creating a Hazard** | • Created a condition capable of causing harm to others<br>• During normal departmental operations | — | Forced removal of situation and 15k speso fine |
| 011 | **Disruptive Comms** | • Knowingly disrupted or needlessly populated a radio frequency<br>• With intent to be a nuisance | — | [Brig until fine paid](#112) (unless [M02](#m02)); 10k speso fine |

<details>
<summary><strong>003 — Superficial Vandalism: Officer Guidance</strong></summary>
...
- If the damage is structural or irreparable (e.g., a smashed fixture), charge [103 — Minor Vandalism](#103) instead.

</details>

<details>
<summary><strong>006 — Drug Possession: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Illegal drugs** — The substance must be confirmed as prohibited aboard the station. Some chemicals are legal when held by licensed medical personnel with documented justification.
2. **Personal-use quantity** — Amounts consistent with individual consumption. If the quantity significantly exceeds what a single person would use, charge [106 — Illegal Distribution](#106) instead.
...
- Quantity is the key distinction between 006 and [106 — Illegal Distribution](#106). Two doses is personal use; twenty is distribution.
- Confiscation is mandatory regardless of whether the fine is also issued.
- Refer licensed medical personnel to the CMO before charging — their possession may be authorized.

</details>

<details>
<summary><strong>007 — Disorderly Conduct: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Conduct unsuitable for their position** — Behavior a reasonable person would find incompatible with the individual's role aboard the station. This is a catch-all for on-duty misconduct that does not fit a more specific charge.
...
- Always prefer a more specific charge (e.g., [101 — Assault](#101), [111 — Discriminatory Language](#111)) when one applies. Use 007 only when no named offense fits.
- When combined with [M02 — Elevated Sentencing](#m02), the outcome is demotion — this requires authorization from the HoS or Captain.

</details>

<details>
<summary><strong>008 — Creating a Hazard: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Created a condition capable of causing harm** — Actively set up or caused a dangerous situation: uncontained chemical spills, exposed electrical hazards, blocked emergency exits, unsecured dangerous equipment, etc.
2. **During normal departmental operations** — Hazards created under direct authorization or as part of a sanctioned emergency response may be exempt. The hazard must be in an operational context, not an isolated accidental event.
...
- Prioritize neutralizing the hazard before processing the individual — crew safety comes first.
- If harm has already occurred as a result, consider whether [108 — Criminal Negligence](#108) better fits the severity.
- A single, minor, accidental hazard from an otherwise cooperative crew member may warrant a warning on a first offense.

</details>

<details>
<summary><strong>011 — Disruptive Comms: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Knowingly disrupted or needlessly populated a frequency** — Repeated, intentional transmissions with no operational purpose: singing, noise, spam, or other non-functional content.
2. **Intent to be a nuisance** — A pattern of behavior or explicit statements of intent are required. An isolated accidental key-up or a single misstep does not satisfy this element.
...
- Deliberate disruption during a Red Alert may warrant escalation under [M02 — Elevated Sentencing](#m02).
...
| Code | Crime | Elements | Related Offenses | Punishment |
|:----:|:------|:---------|:-----------------|:-----------|
| <a id="101"></a>101 | **Assault** | • Used physical force against another person<br>• Without apparent intent to kill | ↓ Greater: [201 — Aggravated Assault](#201) | Restraining and separation; 5 min brig |
| <a id="102"></a>102 | **Pickpocketing** | • Stole an item<br>• Directly from another person's person (pocket, hand, or worn equipment) | ↓ Greater: [202 — Theft](#202) | Return of item(s) and 5 min brig |
...
1. **Physical force** — Direct physical contact was made: striking, shoving, grabbing, or use of a held object to strike. Verbal threats alone are [217 — Intimidation](#217), not Assault.
2. **Against another person** — The target must be a recognized crew member, visitor, or individual aboard the station. Does not apply to an individual's own property.
3. **Without apparent intent to kill** — The attack, while harmful, did not appear intended to cause death. If lethal intent is evident or a deadly weapon is used with intent, charge [201 — Aggravated Assault](#201) or higher.
...
- If the suspect claims self-defense, evaluate whether force was proportional — apply [M03 — Self Defense](#m03) if warranted.
- If injuries are severe (broken bones, critical condition), escalate to [201 — Aggravated Assault](#201).
- Separate the parties before processing — continued proximity risks further incidents.

</details>

<details>
<summary><strong>102 — Pickpocketing: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Stole an item** — Took possession of something that does not belong to them without consent.
2. **Directly from another's person** — The item was taken from a pocket, hand, belt, or worn equipment slot — not from a bag left on the ground or a locker. Items taken from unattended property are [202 — Theft](#202).
...
- Return of the item is mandatory — confirm the item is returned before releasing the individual.
- If items of significant value (workplace equipment, rare gear) are taken from someone's person, consider escalating to [202 — Theft](#202).
- If the individual had a concealed method for removing items (e.g., specialty gloves or tools), document it for the report.

</details>

<details>
<summary><strong>103 — Minor Vandalism: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Damaged, destroyed, or permanently defaced** — Physical harm to the object that leaves lasting damage or requires repair. Cosmetic defacement that can be cleaned is [003 — Superficial Vandalism](#003). Complete destruction that cannot be repaired is [203 — Major Vandalism](#203).
2. **Non-critical furniture, vendor, or personal property** — The target must not be critical station infrastructure. Walls, windows, vending machines, chairs, personal lockers, and crew-owned items qualify. Damage to APCs, pipes, air systems, or station machinery falls under [303 — Sabotage](#303).
...
- Prefer work duty (repairing the damage) over brig time when possible — it addresses the harm directly.
- Assess repairability before charging: cosmetic = 003, repairable damage = 103, irreparable destruction = 203.
- Damage to critical systems is **always** [303 — Sabotage](#303) or higher, regardless of apparent intent.

</details>

<details>
<summary><strong>104 — Vigilantism: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Performed security duties or responsibilities** — Actively arresting, detaining, forcibly searching, or otherwise acting in the capacity of a security officer.
2. **Without approval or due cause** — The individual has no security role, was not deputized, and had no authorization from the HoS or Captain. Acting in immediate self-defense does not constitute vigilantism.
...
<details>
<summary><strong>106 — Illegal Distribution: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Possessed illegal or dangerous drugs or equipment** — The substance or item must be confirmed as prohibited aboard the station.
2. **In quantities beyond reasonable personal use** — The amount substantially exceeds what one person would consume. There is no fixed cutoff — use judgment based on the substance and packaging (e.g., pre-packaged doses, large stockpiles).
...
- Quantity and packaging are the primary distinguishing factors from [006 — Drug Possession](#006). A single dose: 006. A crate of labeled doses: 106.
- If evidence of active distribution exists (buyers identified, credits exchanged), document it — it strengthens the charge.
- Confiscation of all illegal substances is required. Log quantities in the evidence report.

</details>

<details>
<summary><strong>107 — Disturbing the Peace: Officer Guidance</strong></summary>
...
<details>
<summary><strong>108 — Criminal Negligence: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Failed in their duty to a negligent degree** — The individual had a responsibility (professional, situational, or assigned) and failed to meet it in a way that a reasonable person in that role would not.
2. **Caused or risked harm to another** — The failure created a real risk of or actual harm, illness, or negative effect. Near-misses count if the risk was objectively serious.
3. **Did not result in death** — If the negligence directly caused a fatality, charge [308 — Manslaughter](#308) instead.
...
- If multiple people or a whole department were harmed, escalate to [208 — Gross Criminal Negligence](#208).
- Reckless shuttle operation that does not result in death qualifies under this charge.

</details>

<details>
<summary><strong>109 — Trespass: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Present in an area without admission or access** — The individual is in a restricted, access-controlled, or department-exclusive area they have no authorization to enter.
2. **Or remained after being asked to leave** — The individual had or previously had access but was instructed to leave by department staff and refused or failed to do so.
...
<details>
<summary><strong>110 — Breaking and Entering: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Forcible entry** — The individual used any method to bypass normal access controls: hacking, cutting wires, bolt-cutting, prying doors, defeating airlocks, or exploiting access card vulnerabilities. The method does not need to be destructive.
2. **To trespass into an area** — The destination was somewhere the individual was not authorized to enter. Forced entry into one's own department or a department in which one holds authorized access does not qualify.
...
<details>
<summary><strong>111 — Discriminatory Language: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Used language targeting an individual** — The statement was directed at a specific person, not a general expression.
2. **Demeans, generalizes, or de-personifies** — The language reduced the target to a stereotype, slur, or otherwise stripped them of individual dignity based on race, species, spirituality, gender identity, sexual orientation, or other classifiable characteristic.
...
- The [M09 — Hate Crime](#m09) modifier cannot be stacked on top of 111 — it is already implied by the nature of the charge.
- Document the specific language used in the arrest report — vague reports are harder to process.
...
<details>
<summary><strong>112 — Fine Evasion: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Avoided, refused, or was unable to pay a legal fine** — The individual received a valid fine issued under Space Law and has not paid it.
2. **After reasonable notice and opportunity** — Security must have given the individual a reasonable window to pay before converting the fine to brig time.
...
- An individual who genuinely cannot pay is still subject to this charge — inability to pay is not a defense, though it may be a mitigating factor at the Warden's discretion.
...
1. **Brandished a weapon** — Displayed, raised, aimed, or otherwise presented a weapon in a threatening or conspicuous manner in a public or shared space.
2. **Without lawful purpose or due cause** — Security officers on duty, individuals responding to an active Red Alert threat, or individuals using weapons in their licensed professional capacity (e.g., a chef with a knife in the kitchen) are exempt.
...
1. **Physical action against a person** — Direct physical violence: striking with a weapon, stomping, sustained beating, or use of any object to cause serious harm.
2. **Intent to grievously harm** — The attack was conducted with the purpose of causing serious injury. Indicators include weapon choice, continued attack on an incapacitated target, or stated intent.
3. **Without intent to kill** — If lethal intent is evident (vital targeting, preventing revival, use of lethally calibrated weapons), charge [301 — Murder](#301).
...
- Intent is the key distinction from [101 — Assault](#101). An attack that causes serious harm but appeared reckless rather than deliberate may still fit 101.
- If the victim died, regardless of initial intent, charge [301 — Murder](#301) or [308 — Manslaughter](#308) as applicable.
- Apply [M03 — Self Defense](#m03) if the force used was a defensive response to a threat.

</details>

<details>
<summary><strong>202 — Theft: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Stole equipment or items from a workplace** — Took property from a department workspace, locker, or common area without authorization. This covers tools, department equipment, and supplies — not items carried on a person.
2. **Or items of extraordinary value from a person's person** — Took high-value items (valuable equipment, rare goods) directly from an individual. For common items taken from a person, see [102 — Pickpocketing](#102). For rare or restricted items, see [302 — Larceny](#302).
...
- If items were taken from a secure or access-controlled area, consider adding [109 — Trespass](#109) or [110 — Breaking and Entering](#110).

</details>

<details>
<summary><strong>203 — Vandalism, Major: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Destroyed or damaged non-critical property** — The target was furniture, a vendor, or personal property — not critical station infrastructure.
2. **In a manner that cannot be repaired** — The item is permanently destroyed, functionally inoperable, or must be wholly replaced. Property that can be repaired is [103 — Minor Vandalism](#103).
...
- Monetary recompensation is required — determine replacement value with the department head or Captain if contested.
- Destruction of critical systems is [303 — Sabotage](#303), not this charge, regardless of intent.

</details>

<details>
<summary><strong>204 — Conspiracy: Officer Guidance</strong></summary>
...
<details>
<summary><strong>205 — Hostile Agent: Officer Guidance</strong></summary>
...
- Supporting a hostile group without directly participating in attacks distinguishes 205 from [305 — Hostile Activity](#305).
- If the individual is a confirmed member of a hostile organization (not merely a supporter), charge [405 — Enemy of the Government](#405).
- This charge often arises as part of a broader investigation — document all connections found.

</details>

<details>
<summary><strong>206 — Possession, Contraband Equipment: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Possessed Class 2 contraband equipment** — Class 2 items are restricted but not outright illegal in all contexts. They include certain weapons, implants, and tools that require a C2 permit to carry legally.
2. **Without a valid C2 Permit** — The individual must not hold an active permit authorizing possession of the specific item.
...
- Verify permit status with the Warden or HoS before charging — some crew may have authorized carry that is not immediately visible.
- Confiscation is mandatory. Log the item in the evidence locker.

</details>

<details>
<summary><strong>207 — Rioting: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Acted as a member of a group** — The individual was an active participant in the collective action, not merely a bystander.
2. **Collectively committed felony-level crimes** — The group as a whole engaged in major vandalism, sabotage, or other crimes of felony severity or higher. Minor property damage by a crowd is [107 — Disturbing the Peace](#107).
...
- If the individual organized or incited the riot, charge [307 — Inciting a Riot](#307) instead.
- Document which individuals committed which acts where possible — it aids in layering additional charges.

</details>

<details>
<summary><strong>208 — Gross Criminal Negligence: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Negligent in their duty** — The individual failed in a professional or assigned responsibility in a way that a reasonably competent person in that role would not.
2. **Caused widespread or serious harm** — The failure harmed multiple individuals, an entire department's function, or caused a single serious injury requiring emergency medical treatment. Single-person harm without emergency treatment needed is [108 — Criminal Negligence](#108).
...
- If the negligence resulted in death, charge [308 — Manslaughter](#308) instead of or in addition to 208.

</details>

<details>
<summary><strong>209 — Trespass, Inherently Dangerous Areas: Officer Guidance</strong></summary>
...
<details>
<summary><strong>210 — Breaking and Entering, Inherently Dangerous Areas: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Forcible entry** — The individual bypassed access controls through any method: hacking, cutting, bypassing airlocks, destroying barriers. Entry does not need to be destructive.
2. **Into a dangerous area** — As defined in [209 — Trespass, Inherently Dangerous Areas](#209): engineering, atmospherics, hazardous labs, NFZ-covered spaces, etc.
...
- Always charge this alongside [209](#209) when forcible entry into a dangerous area is confirmed.
- Additional brig time may be applied based on damage caused to access panels, doors, or other infrastructure.
- If the destination was a high security area (armory, command offices), charge [310 — Breaking and Entering, High Security Areas](#310) instead.

</details>

<details>
<summary><strong>211 — Insubordination: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Knowingly disobeyed a lawful order** — The individual was aware of the order and chose not to comply. Inability to physically comply, or compliance that was delayed due to circumstances, is not insubordination.
2. **From a superior or security officer** — The order must come from someone with recognized authority: a department head, the HoS, the Captain, or a security officer acting in their official capacity.
3. **Without good reason** — A valid reason (safety concern, conflicting lawful order from a higher authority, ethical obligation) negates this charge. The individual must demonstrate the reason, not simply claim one.
...
<details>
<summary><strong>212 — Fraud: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Misrepresented their intentions** — Deliberately presented false information, a false identity, or a false purpose.
2. **To gain property or money** — The deception was executed with the goal of obtaining something of value — material goods, credits, access, or services — from another individual.
...
- Both elements must be satisfied: misrepresentation alone (without gain) may be [314 — Impersonation](#314). Gain through other unlawful means may be [202 — Theft](#202).
- Return of all fraudulently obtained property or money is mandatory.
- If the fraud involved assuming another crew member's identity, layer [314 — Impersonation](#314).

</details>

<details>
<summary><strong>213 — Mutilation: Officer Guidance</strong></summary>
...
<details>
<summary><strong>215 — False Imprisonment: Officer Guidance</strong></summary>
...
<details>
<summary><strong>217 — Intimidation: Officer Guidance</strong></summary>
...
<details>
<summary><strong>218 — Sexual Harassment: Officer Guidance</strong></summary>
...
- If the conduct involved physical contact that constitutes an involuntary sexual act, charge [318 — Sexual Assault](#318) instead.
- Handle reports with discretion — record victim statements carefully and limit disclosure of details to those directly involved in processing the charge.
...
| <a id="309"></a>309 | **Trespass, High Security Areas** | • Trespassed without permission<br>• In Command areas, personal offices, weapons/explosive storage or production, or other high security areas<br>• Includes NT Vaults, Syndicate caches, and NFZ-covered space | ↑ Lesser: [209 — Trespass, Inherently Dangerous Areas](#209) | 15 min brig, return of items taken, 45–60k speso fine; NFZ violation adds half the time spent in NFZ |
| <a id="310"></a>310 | **Breaking and Entering, High Security Areas** | • Used forcible entry to trespass<br>• Into a high security area as defined under [309 — Trespass, High Security Areas](#309) | ↑ Lesser: [210 — Breaking and Entering, Inherently Dangerous Areas](#210) | As per [210](#210), plus an additional 10k speso fine |
| <a id="311"></a>311 | **Dereliction** | • Willfully abandoned an obligation<br>• Critical to the station's continued operation | ↓ Greater: [411 — Grand Dereliction](#411) | Demotion, 40k speso fine |
| 312 | **Embezzlement** | • Embezzled funds from station fund computers | — | Return of funds, 40k fine, demotion, 15 min brig |
| 313 | **Illegal Mindbreaking** | • Permanently removed a psion's abilities<br>• Not as a lawful punishment, by a Mantis in the line of duty, or during an extenuating emergency | — | 15 min brig, 85k fine, restoration of psion's powers if able, removal of perpetrator's powers if applicable |
| 314 | **Impersonation** | • Assumed the identity of another individual or job | — | Removal of items used to impersonate, 40k speso fine, 10 min brig |
...
1. **Purposefully killed** — The individual took actions that directly resulted in another person's death, with intent to kill. Accidental or negligent killing is [308 — Manslaughter](#308). Killing with intent to prevent revival escalates to [401 — Capital Murder](#401).

**Standard of Proof** — *Probable Cause required for arrest; Preponderance of Evidence required for sentencing*

PC may be established by: direct observation, camera footage, forensic evidence (cause of death, weapon), or credible witness testimony establishing the individual as the killer. Intent must be articulable — weapon choice, continued attack, or stated intent all support a murder charge over manslaughter.

**Officer Notes**

- If the victim was revived, murder is still chargeable — the act of killing constitutes the offense.
- If the individual took steps to prevent revival (destroying the body, hiding it), charge [401 — Capital Murder](#401).
- Apply [M03 — Self Defense](#m03) only when the force used was clearly proportional to a genuine threat — lethal force in response to minor aggression is not self-defense.

</details>

<details>
<summary><strong>302 — Larceny: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Stole rare, expensive, or restricted equipment** — The item must be valued above 50,000 speso, be classified as rare, or be access-restricted (armory gear, medical implants, command equipment, etc.).
2. **From a secure area or from a person** — The item was taken from a secured location or directly from an individual. Taking common items from unsecured workspaces is [202 — Theft](#202).
...
- Value determines the tier: under 50k from a workplace = [202 — Theft](#202); over 50k, restricted, or rare = 302.
...
<details>
<summary><strong>303 — Sabotage: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Destroyed critical assets or resources** — The target must be something the station's normal or emergency operation depends on: power systems, atmospheric equipment, medical equipment, communication arrays, shuttle systems.
2. **Or caused sections to become uninhabitable** — Actions that breached hull integrity, vented atmosphere, flooded with radiation, or otherwise rendered an area inaccessible or dangerous to crew.
...
- Distinguishing 303 from [103 — Minor Vandalism](#103) or [203 — Major Vandalism](#203): the target must be critical to station operation. A broken chair is vandalism; a destroyed APC is sabotage.
- If the damage would render the entire station uninhabitable or collapse station function entirely, escalate to [403 — Grand Sabotage](#403).
- Intent is not strictly required — reckless destruction of critical systems qualifies.

</details>

<details>
<summary><strong>304 — Grand Conspiracy: Officer Guidance</strong></summary>
...
<details>
<summary><strong>305 — Hostile Activity: Officer Guidance</strong></summary>
...
- [205 — Hostile Agent](#205) covers passive support; 305 covers active participation. Direct attacks, sabotage operations, or intelligence delivery for a hostile group all fall under 305.
- If the individual is confirmed as a member of a hostile organization (not merely acting on their behalf), charge [405 — Enemy of the Government](#405).
- Document all evidence carefully — hostile activity charges are often part of larger investigations.

</details>

<details>
<summary><strong>306 — Possession, Illegal Inherently Dangerous Equipment: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Possessed restricted or illegal equipment** — The item must be classified as C3 or otherwise prohibited without special authorization that does not exist for the individual.
2. **With primary purpose of causing harm or destruction** — The item's primary design function is to harm people or cause large-scale damage: military-grade weapons, explosive devices, mass-casualty tools, etc. Items with dual use (tools that could be weaponized) do not automatically qualify.
...
<details>
<summary><strong>307 — Inciting a Riot: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Actions intended to cause large-scale unrest** — The individual took specific steps to agitate, provoke, or coordinate others toward collective violence or disruption — not simply expressing anger.
2. **Up to and including facilitating rioting** — The incitement either resulted in or was clearly aimed at producing the conditions for a riot. The riot does not need to have actually occurred if the intent and steps taken are documented.
...
- Distinguish from [207 — Rioting](#207): a rioter is a participant; an inciter is an organizer or provocateur. Both charges may apply to the same individual if they both incited and participated.
- If a riot resulted but no leader can be clearly identified, charge participants with [207 — Rioting](#207) instead.
- The charge does not require the riot to have occurred — intent and steps taken are sufficient.

</details>

<details>
<summary><strong>308 — Manslaughter: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Unintentionally killed another person** — The death was a direct result of the individual's actions, but killing was not the goal.
2. **Through negligent but non-malicious actions** — The individual acted carelessly, recklessly, or failed in a duty — but did not intend harm. Malicious actions that result in unintended death still constitute [301 — Murder](#301).
...
- If negligence was so extreme it demonstrated callous disregard for life, a murder charge may still be appropriate — consult the HoS.

</details>

<details>
<summary><strong>309 — Trespass, High Security Areas: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Trespassed without permission** — Present in a high security area without authorization, or remained after being asked to leave.
2. **In a high security area** — Command areas, personal offices of command staff, weapons storage/production facilities, explosive storage/production facilities, NT Vaults, Syndicate caches, or NFZ-covered space. These are more restricted than dangerous areas (209) because of the combination of sensitivity and hazard.
...
- Any items taken from the high security area must be returned — document all recovered items.
- If the individual broke in rather than finding an open door, add [310 — Breaking and Entering, High Security Areas](#310).

</details>

<details>
<summary><strong>310 — Breaking and Entering, High Security Areas: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Forcible entry** — Bypassed access controls through any method: hacking, cutting, bypassing locks, exploiting access card vulnerabilities.
2. **Into a high security area** — As defined under [309 — Trespass, High Security Areas](#309): command offices, weapons/explosive storage, vaults, etc.
...
- Always charge alongside [309 — Trespass, High Security Areas](#309) when entry was forced.
- The base punishment mirrors [210](#210) with an additional 10k speso fine for the elevated security context.
- Document all items in the individual's possession when apprehended — recovery from high security areas often involves stolen restricted equipment.

</details>

<details>
<summary><strong>311 — Dereliction: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Willfully abandoned an obligation** — The individual actively chose not to perform their duty — not incapacity, emergency, or circumstance preventing them. Willfulness is required; being overwhelmed is not dereliction.
2. **Critical to the station's continued operation** — The abandoned duty directly affected the station's ability to function: engineering not maintaining power, medical not responding to critical patients, security not responding to active threats.
...
- Demotion is the primary sanction — this charge is about professional responsibility. Confirm with the relevant department head and the Captain.
...
<details>
<summary><strong>312 — Embezzlement: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Embezzled funds from station fund computers** — The individual accessed station financial systems and transferred, diverted, or misappropriated funds for personal gain or unauthorized purposes.
...
- Demotion is required — the individual loses the access that enabled the crime.
- If funds were diverted to a hostile organization, consider adding [305 — Hostile Activity](#305).

</details>

<details>
<summary><strong>313 — Illegal Mindbreaking: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Permanently removed a psion's abilities** — Performed an action that results in the irreversible loss of a psion's psionic capabilities.
2. **Not under authorized circumstances** — Lawful punishments ordered by command, actions by a Mantis performing their duty, or emergency situations where no alternative exists are exempt.
...
- Restoration of abilities is required if medically possible — coordinate with the CMO and any available Mantis.
...
<details>
<summary><strong>314 — Impersonation: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Assumed the identity of another individual or job** — Actively represented themselves as someone they are not — using another crew member's ID, wearing unauthorized uniforms, or falsely claiming a role or title.
...
- If the impersonation was used to gain property or money, add [212 — Fraud](#212).
- Impersonating a security officer or command staff is an aggravating factor — note it in the report and consider whether [M02 — Elevated Sentencing](#m02) applies.

</details>

<details>
<summary><strong>315 — Kidnapping: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Unlawfully abducted a person** — Took physical control of a person without their consent and without legal authority.
2. **Transported them to a new location** — Moved the victim from where they were taken to a different place.
3. **Confined them against their will** — Prevented them from leaving the new location. All three elements must be present — detention alone without transport is [215 — False Imprisonment](#215).
...
- All three elements must be established: abduction, transport, and confinement. Missing any one shifts the charge to [215 — False Imprisonment](#215).
- If the victim was a Command member or higher, charge [415 — Grand Kidnapping](#415) instead.
- Investigate the motive — kidnapping often accompanies other charges (coercion, hostile activity, etc.).

</details>

<details>
<summary><strong>317 — Coercion: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Offered or accepted a bribe** — Either party to the exchange may be charged: the one offering and the one accepting.
2. **As or to a contracted station member** — At least one party must be a crew member with official station responsibilities. Bribing a private citizen is fraud; bribing a crew member or official is coercion.
3. **Or blackmailed someone** — Used knowledge of a real or fabricated compromising fact to extract money, goods, or actions under threat of exposure.
...
- Both the briber and the recipient can be charged — document all parties involved.
...
<details>
<summary><strong>318 — Sexual Assault: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Involuntary, non-consensual sexual act** — The act was sexual in nature and was not consented to by the victim.
2. **Ranging from unwanted touching to forced penetration** — The charge covers a spectrum of severity. Greater severity within this range may warrant elevated sentencing via [M02](#m02).
3. **Violating bodily autonomy** — The victim's right to control what happens to their body was disregarded.
...
| Code | Crime | Elements | Related Offenses | Punishment |
|:----:|:------|:---------|:-----------------|:-----------|
| <a id="401"></a>401 | **Capital Murder** | • Committed murder with clear intent to kill<br>• And materially took steps to prevent the victim's revival<br>• Or forced Borging or discorporealization without consent or authorization | ↑ Lesser: [301 — Murder](#301) | Execution, Permanent Confinement, or Force Borgification |
| <a id="403"></a>403 | **Grand Sabotage** | • Destroyed or modified station assets or equipment<br>• Without which the station may collapse or become entirely uninhabitable | ↑ Lesser: [303 — Sabotage](#303) | Permanent Confinement, Demotion |
| 404 | **Espionage** | • Knowingly betrayed critical station information<br>• To enemies of the station | — | Permanent Confinement |
| <a id="405"></a>405 | **Enemy of the Government** | • Is or was a confirmed member of a hostile organization: True Nexus, Xenoborg Collective, hostile boarding parties, Changeling Hiveminds, cults, or Dirizher Cartel | ↑ Lesser: [205 — Hostile Agent](#205), [305 — Hostile Activity](#305) | Permanent Confinement or transportation to Colonial Command for interrogation |
| 407 | **Subversion of the Chain of Command** | • Disrupted the chain of command via the murder of a commanding officer<br>• Or illegally declared oneself to be a commanding officer | — | Permanent Confinement; Execution if Criminal is a Head Revolutionary |
| 408 | **Biological Terror** | • Knowingly released or caused the station to be affected by a disease, plant, or biological form<br>• That may spread uncontained and/or cause serious physical harm | — | Permanent Confinement, Execution, or Force Borgification |
| <a id="411"></a>411 | **Grand Dereliction** | • As security or command, acted in a way detrimental to the station, sector, or Colonial Command<br>• Examples: selling station gear to spacers, intentionally permitting or encouraging felony or capital crimes | ↑ Lesser: [311 — Dereliction](#311) | Permanent Confinement, transportation to Colonial Command, Execution in extreme cases |
| <a id="415"></a>415 | **Grand Kidnapping** | • Unlawfully abducted a Command member or higher authority<br>• And confined them against their will | ↑ Lesser: [315 — Kidnapping](#315) | Permanent Confinement |
| 416 | **Perfidy** | • Intentionally baited Security or Command with a peaceful resolution<br>• Then betrayed their trust to elude capture or launch a surprise attack | — | Permanent Confinement |
| 417 | **Brainwashing** | • Brainwashed someone non-consensually<br>• Or caused them to commit crimes under mind control | — | Punishments applied for crimes committed by the brainwashed; Permanent Confinement, Forced Borgification, or Execution |

<details>
<summary><strong>401 — Capital Murder: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Murder with clear intent to kill** — The base act of [301 — Murder](#301) must be established first: a purposeful killing.
2. **Materially took steps to prevent revival** — Actions taken to ensure the victim cannot be resuscitated: destroying or hiding the body, preventing medical access, using lethally calibrated weapons set to bypass medical revival, or killing in an area where revival is impossible.
3. **Or forced Borging/discorporealization** — Non-consensually converting a person to a Borg or discorporealized state without authorization from command constitutes Capital Murder even if the body technically survives.

**Standard of Proof** — *Preponderance of Evidence required; Captain authorization for execution*
...
- Distinguish from [301 — Murder](#301) by the presence of anti-revival steps. A killing without such steps, however brutal, is 301.
...
- Execution must be announced over comms with charges, reasoning, method, and time. A fax to Colonial Command must be sent. See [Brigging Procedures](#brigging-procedures).

</details>

<details>
<summary><strong>403 — Grand Sabotage: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Destroyed or modified station assets** — Took deliberate action to damage, destroy, or alter critical station infrastructure.
2. **Without which the station may collapse or become uninhabitable** — The targeted systems are so critical that their loss threatens the viability of the station itself: main power grid, life support, core structural integrity, or similar foundational systems.

**Standard of Proof** — *Preponderance of Evidence required*

PC may be established by: the scale of damage confirming it goes beyond [303 — Sabotage](#303), access logs and forensic evidence linking the individual, and confirmation from engineering or command of the systems affected.

**Officer Notes**

- Distinguish from [303 — Sabotage](#303) by the scope: 303 damages important systems; 403 threatens station survival.
- Intent is not strictly required — willful destruction of foundational systems qualifies even if the individual claimed a different goal.
- Permanent Confinement is the baseline; Execution may be warranted in cases where the act resulted in mass casualties.

</details>

<details>
<summary><strong>404 — Espionage: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Betrayed critical information** — Shared, transmitted, or leaked sensitive station data: security codes, ship layouts, personnel information, defensive capabilities, or operational plans.
2. **To enemies of the station** — The recipient must be a hostile party: any organization listed under [405 — Enemy of the Government](#405), a rival faction, or an external entity in opposition to the station.
...
- The information must be confirmed as critical — sharing non-sensitive information with a hostile contact is [305 — Hostile Activity](#305), not Espionage.
- Espionage often accompanies [404 — Espionage](#404) with [405 — Enemy of the Government](#405) if the individual is also a confirmed member of a hostile organization.
- Fax Colonial Command — espionage cases may have off-station implications that command needs to know about.

</details>

<details>
<summary><strong>405 — Enemy of the Government: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Confirmed membership in a hostile organization** — The individual is, or was during the relevant period, an active member of: True Nexus, the Xenoborg Collective, hostile boarding parties, Changeling Hiveminds, cults, or the Dirizher Cartel.
...
- Mere sympathy for a hostile organization is [205 — Hostile Agent](#205). Confirmed membership is 405.
- Individuals under [M12 — Hostile Brainwashing](#m12) (mind control) are to be deconverted and released once freed — they are not charged with 405 if they acted under compulsion.
...
<details>
<summary><strong>407 — Subversion of the Chain of Command: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Murdered a commanding officer** — Killed a recognized member of the Command staff in a way that disrupted the chain of command.
2. **Or illegally declared oneself a commanding officer** — Assumed command authority without legitimate succession: declaring oneself Captain without authorization, taking over a department by force, etc.

**Standard of Proof** — *Preponderance of Evidence required; Captain authorization for execution*

PC for murder: as per [301 — Murder](#301). PC for false command assumption: witness testimony or documented communications of the false claim.

**Officer Notes**

- Head Revolutionaries who subvert the chain of command may be executed — this requires Captain authorization and standard execution procedures.
- A legitimate succession (acting Captain during incapacitation of the Captain) does not qualify — the assumption of command must be illegal.
- If the HoS is the individual attempting subversion, escalate immediately to the Captain or Colonial Command via fax.

</details>

<details>
<summary><strong>408 — Biological Terror: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Knowingly released a biological threat** — Deliberately introduced or caused the spread of a disease, plant, organism, or other biological agent. Accidental contamination should be investigated before charging.
2. **Capable of spreading and causing serious harm** — The agent has the potential to propagate beyond initial release and cause meaningful physical harm to crew.
...
- Accidental contamination (a spill, a broken containment vessel) requires investigation before charging — "knowingly" is a key element. If intent cannot be established, consider [208 — Gross Criminal Negligence](#208) instead.
- Force Borgification is available as a sentence if the individual was the vector of transmission and poses continued risk.
- Coordinate with Medical immediately upon confirmation — containment takes priority over processing the individual.

</details>

<details>
<summary><strong>411 — Grand Dereliction: Officer Guidance</strong></summary>

**Elements in Detail**

1. **As security or command** — This charge applies only to individuals in security or command roles. It holds those with the most responsibility to the highest standard.
2. **Acted to the detriment of the station, sector, or Colonial Command** — The dereliction must have materially harmed or endangered the station or its mission: selling gear, enabling criminals, providing cover for hostile activity, or deliberately ignoring serious threats.
...
- Distinguish from [311 — Dereliction](#311) by role (must be security or command) and scale (the act was actively harmful to the station or Colonial Command, not merely a failure of duty).
- Execution is reserved for extreme cases where the dereliction constituted active betrayal — requires Captain authorization and full execution procedures.
- If the Grand Dereliction involved working with a hostile organization, layer [305 — Hostile Activity](#305) or [405 — Enemy of the Government](#405).

</details>

<details>
<summary><strong>415 — Grand Kidnapping: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Unlawfully abducted** — Took physical control of a person without their consent and without legal authority.
2. **A Command member or higher authority** — The victim must hold a Command position: Captain, HoS, CMO, CE, RD, or equivalent. Kidnapping non-Command crew is [315 — Kidnapping](#315).
3. **And confined them against their will** — Prevented them from leaving.
...
- The elevated charge reflects the threat to station command structure — the Captain and Colonial Command must be informed immediately.
- If the Command member was harmed or killed in the process, layer [301 — Murder](#301) or [401 — Capital Murder](#401) as applicable.
- Treat this as a station-wide priority — the incapacitation of Command is a strategic threat.

</details>

<details>
<summary><strong>416 — Perfidy: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Baited Security or Command with a peaceful resolution** — The individual signaled willingness to surrender, comply, or negotiate peacefully: raised hands, verbal surrender, agreeing to be cuffed, requesting parley.
2. **Then betrayed that trust** — Used the moment of reduced guard to escape, launch an attack, or otherwise exploit the situation created by the false peaceful signal.
...
- Both elements must be clearly established — the false surrender and the subsequent exploitation. A suspect who attacks during an arrest without any feigned compliance is not committing Perfidy.
...
<details>
<summary><strong>417 — Brainwashing: Officer Guidance</strong></summary>

**Elements in Detail**

1. **Brainwashed someone non-consensually** — Used psionic, cult, chemical, or technological means to override or control another person's will without their agreement.
2. **Or caused them to commit crimes under control** — The brainwashing resulted in the victim committing criminal acts they would not have committed freely.
...
- The brainwasher bears criminal responsibility for acts committed by the victim under their control — the victim is charged under [M12 — Hostile Brainwashing](#m12) and released upon deconversion.
- The brainwasher's sentence includes the crimes committed by their victim — document all crimes committed by controlled individuals.
...
## Prisoner Infractions

| Prisoner Classification | E-01: In-Cell Vandalism | E-02: Attempted Escape | E-03: Escape |
|:------------------------|:------------------------|:-----------------------|:-------------|
| **Temporary** | Reset timer | Reset timer / Isolation (discretionary) | Reset timer, +10 minutes |
| **Permanent** | Removal of luxuries | Isolation 10 minutes | Re-detained or Executed (discretionary) |
| **Isolation** | Straight jacket | Straightjacket or Execution (discretionary) | Re-detained or Executed (discretionary) |
